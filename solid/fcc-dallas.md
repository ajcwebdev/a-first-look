...
```bash
mkdir ajcwebdev-solid-dallas
cd ajcwebdev-solid-dallas
pnpm init
pnpm add -D solid-js \
  @solidjs/meta @solidjs/router \
  solid-start solid-start-node \
  vite vite-plugin-solid undici \
  vercel netlify-cli @babel/core typescript webpack
...
```json
{
  "name": "ajcwebdev-solid-dallas",
  "version": "1.0.0",
  "description": "An example SolidJS application deployed on Netlify and Vercel",
  "type": "module",
  "scripts": {
    "dev": "vite",
    "build": "vite build",
  ...
  "keywords": [ "SolidJS", "Netlify", "Vercel" ],
...
git add .
git commit -m "solid"
gh repo create ajcwebdev-solid-dallas \
  --description="An example SolidJS application deployed on Netlify and Vercel" \
  --public \
  --push \
  --source=. \
...
? Site name (you can change it later): ajcwebdev-solid-dallas

Site Created

Admin URL: https://app.netlify.com/sites/ajcwebdev-solid-dallas
URL:       https://ajcwebdev-solid-dallas.netlify.app
Site ID:   xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx

Linked to ajcwebdev-solid-dallas
...
Open [ajcwebdev-solid-dallas.netlify.app](https://ajcwebdev-solid-dallas.netlify.app/).
...
Open [ajcwebdev-solid-dallas.vercel.app](https://ajcwebdev-solid-dallas.vercel.app/).
...
Return to [ajcwebdev-solid-dallas.netlify.app](https://ajcwebdev-solid-dallas.netlify.app/).
